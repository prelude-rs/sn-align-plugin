...
- [x] **Phase 1: API Diff Audit** - Capture written audit of every breaking change, new API, and fixed quirk in sn-plugin-lib 0.1.19 → 0.1.43 (completed 2026-05-17)
...
**Plans**: 6 plans
  ...
  - [x] 01-01-PLAN.md — Evidence: .d.ts machine diff between 0.1.19 and 0.1.43 (audit branch + scratch installs)
  - [x] 01-02-PLAN.md — Evidence: ghost-upgrade tsc + jest logs on scratch/ricardo/ghost-0.1.43
  - [x] 01-03-PLAN.md — Audit doc: call-site sweep + Breaking / Behavioral / Net-new buckets
  - [x] 01-04-PLAN.md — Audit doc §6: four targeted answers (AsyncStorage, modifyButtonRes, page-bounds, lasso/page APIs)
  - [x] 01-05-PLAN.md — Audit doc §7 + §8: sn-plugin skill gotcha cross-reference + Unknowns / Paper-only Claims
  - [x] 01-06-PLAN.md — Final consistency pass + scratch branch deletion (D-15)
...
|-------|----------------|--------|-----------|
| 1. API Diff Audit | 6/6 | Complete   | 2026-05-17 |
